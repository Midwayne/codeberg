...
help:
	...
	@echo "    make build-agent          Install deps and build the agent"
	...
	@echo "    make build-web-ui         Build the browser chat SPA (web-ui/dist)"
...
# it here lets the server use the rich UI instead of the fallback page.
build-web-ui:
