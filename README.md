...
| `agent/` | TypeScript ai-sdk agent — CLI + browser chat — over the daemon API ([docs](agent/README.md)) |
...
| **Node** ≥ 22 + **npm** | build & run the TypeScript agent | `brew install node` | `nodejs npm` |
